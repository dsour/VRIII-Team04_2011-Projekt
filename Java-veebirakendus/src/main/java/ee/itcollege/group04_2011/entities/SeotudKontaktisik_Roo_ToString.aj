...
privileged aspect SeotudKontaktisik_Roo_ToString {
    
    public String SeotudKontaktisik.toString() {
        ...
        sb.append("SuguluseRolliLiik: ").append(getSuguluseRolliLiik()).append(", ");
